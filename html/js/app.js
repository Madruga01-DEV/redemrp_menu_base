(function () {
    let MenuTpl =
        ...
        '{{#image}}<img style="width: 90px;height: 90px;background-blend-mode: screen;background-repeat: round;align-content: center;padding: 5px;" src="{{{image}}}">{{/image}}' +
        ...
        '<img style="width: 250px ;height: 150px;background-image: url(nui://redemrp_menu_base/html/slot-bk.png);background-blend-mode: screen;background-repeat: round;align-content: center;padding: 10px;" src={{{src}}}>' +
                ...
                for (let i = 0; i < menuData.elements.length; i++) {
                    ...
                    if (element.image) {
                        if (element.image.includes("https://")) {
                            ...
                            element.image = "nui://redemrp_menu_base/html/" + element.image;
                        }
                        else {
                            element.image = "nui://redemrp_menu_base/html/" + element.image + ".png";
                        }
                    }
                    switch (element.type) {
                        case 'default':
